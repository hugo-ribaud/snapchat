...
export default class List extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch("https://snapi-wac.herokuapp.com/all", {
            method: "get",
            headers: {
...

        {
            Alert.prompt("Enter duration", null, (second) => {
                if (!isNaN(second)) {
                    ...
                    Alert.alert(
                        "State",
                        "You're snap will be sent with 10 seconds duration"
                    );
                    console.log(this.state.duration);
                }
            });
    ...
    render() {
        return (
            <SafeAreaView>
                <ImageBackground
                    source={{ uri: `data:image/gif;base64,${this.state.picture.base64}` }}
                            ...
                            return (
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        fetch("https://snapi-wac.herokuapp.com/snaps", {
                                            method: "POST",
                                            body: data,
                                            headers: {
